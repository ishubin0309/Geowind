    ...
    public function publishAction(Request $request)
    {
        if(isset($_POST['projet_technologie'])) {
            ...
            if($zip_val->open($fullPath) == true) {
                ...
                $message = str_replace('{personnes_physiques}', $personesPhysiquesRow, $message);
