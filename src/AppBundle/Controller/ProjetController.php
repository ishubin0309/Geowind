...
class ProjetController extends Controller
{
    ...
    public function publishAction(Request $request)
    {
        if(isset($_POST['projet_technologie'])) {
			...
			$titleRow = '<w:p w14:paraId="28397692" w14:textId="77777777" w:rsidR="00045C8A" w:rsidRPr="00045C8A" w:rsidRDefault="00045C8A" w:rsidP="00045C8A"><w:r w:rsidRPr="00045C8A"><w:pPr><w:spacing w:before="-6"/><w:rPr><w:b/><w:sz w:val="18"/><w:szCs w:val="20"/></w:rPr></w:pPr><w:t>{title}</w:t></w:r></w:p>';
			$replaceThis = [];
            $replaceBy = [];
