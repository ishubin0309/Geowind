        ...
        if(isset($_POST['projet_technologie'])) {
			...
			for ($i=0; $i <= 4; $i++) {
				...
				if (isset($_POST['proprietaire' . $j . '_identite']) && $_POST['proprietaire' . $j . '_identite']) {
					echo '<pre>';print_r([$_POST['proprietaire' . $j . '_civilite}'], $_POST['proprietaire' . $j . '_identite}'], $_POST['proprietaire' . $j . '_ne_le}'], $_POST['proprietaire' . $j . '_ne_a}'], $_POST['proprietaire' . $j . '_adresse}'], $_POST['proprietaire' . $j . '_droit}'], $_POST['proprietaire' . $j . '_marital}'], $_POST['proprietaire' . $j . '_qualite}']]);
